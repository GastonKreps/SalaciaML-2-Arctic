...
def generate_and_save_stats(df, output_path="stats_temp.txt"):
    ...
    # Use the final ML Quality Flag for temperature statistics
    final_qf_col = 'ML_QF_Temperature'
    ...
    stats_content = (
        f" SalaciaML Arctic Temperature Application Stats Output\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--stats', default='stats_temp.txt', help='Output statistics file path.')
